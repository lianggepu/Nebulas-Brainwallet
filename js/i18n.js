    ...
    var table = {
        en: {
            ...
            "new/comment": "This password encrypts your private key.\n" +
                "This password generate your keys.\n" +
                "You will need only this password to recovery and unlock your wallet.\nPlease use a strong password and keep firmly in mind!",
        ...
        zh: {
            ...
            "keystore-file": "密码库文件",
            name: "简体中文",
            "new/comment": "该密码用于产生您的私钥。\n它同时用于加密您的私钥。\n您仅需要该密码就可以恢复并解锁您的钱包。\n请务必使用高强度密码并牢记它，一旦忘记您将彻底丢失该钱包!!!",
